...
if(password !== confirmPassword){
    return res.json ({success : false , message : "Password & ConfirmPassword not matched"});  
}

const isEmailExists = await UserSchema.findOne({email:email});
// console.log(isEmailExists,"isEmailExists");
if(isEmailExists){
    return res.json({success : false, message : "Email already exist,Please use another email id"});
}
